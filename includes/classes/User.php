<?php
class User {
	private $user; //private: Only this class is able to access the variable $user, 
	private $con;
	...
	public function isFriend($username_to_check) {
		...
		//strstr = checks if string is inside a string
	...
	public function removeFriend($user_to_remove) {
		...
		$new_friend_array = str_replace($user_to_remove . ",", "", $this->user['friend_array']); // It will look for $user_to_remove followed by comma and replace it with blank ie nothing
